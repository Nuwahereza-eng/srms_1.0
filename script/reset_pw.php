...
<p class="text-muted login_paragraph">Student Reset Password</p>
</div>
<form autocomplete="off" class="app_frm" action="routes/student_reset_pw" method="POST">
<div class="mb-2">
<label class="form-label">Registration Number</label>
<div class="input-group">
<input required type="text" class="js-masked-regno form-control" name="reg_no" placeholder="Enter registration number">
...
<div class="mb-3"><button type="submit" name="submit" value="1" class="btn w-100 btn-primary app_btn">Reset Password</button>
</div>
...
<script>
jQuery(".js-masked-regno:not(.js-masked-enabled)").mask("<?php echo $info['short_code']; ?>/99/9/999999");
</script>
