...
if (empty($ds->check_name($sanitezed_data['name'], $_POST['id']))) {
...
$ds->update($_POST['id'], $data);

$utility->setMessage("success", 'Division system updated');
header("location:../division_systems");

}else{

$utility->setMessage("warning", 'Division system is already registered');
header("location:../division_systems");
