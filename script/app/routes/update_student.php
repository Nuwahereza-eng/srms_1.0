...
if (isset($_SESSION['current_image_edit'])) {
...
if ($photo !== $_POST['old_file']) {

$utility->delete_file('storage/images/students/'.$_POST['old_file']);
...
$utility->setMessage("success", "Student updated sucessfully");
header("location:../edit_student?reg=".$_POST['id']);
