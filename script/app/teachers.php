...
<title><?php echo $info['name'].' - Teachers'; ?></title>
...
<h4 class="block-title">Add Teacher</h4>
</div>
<div class="block-content">
<form autocomplete="off" class="app_frm" action="app/routes/add_teacher" method="POST">
<div class="mb-2">
...
<input type="text" required class="form-control" name="last_name" placeholder="Enter last name">
</div>
<div class="mb-2">
...
<?= $utility->csrf_field('add_teacher.php', 600) ?>
<div class="mb-4">
...
<div class="block block-rounded block-themed block-transparent mb-0">
<div class="block-header bg-primary-dark">
<h4 class="block-title">Import Teachers</h4>
</div>
<div class="block-content">
<form autocomplete="off" class="app_frm" enctype="multipart/form-data" action="app/routes/import_teachers" method="POST">
<div class="mb-2">
...
Download excel template from <a download href="storage/templates/import_teachers.xlsx" class="alert-link">here</a>.
</div>
</div>
<?= $utility->csrf_field('import_teachers.php', 600) ?>
<div class="mb-4">
<button type="submit" class="btn btn-primary">Save</button>
<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
</div>
...
<div class="block block-rounded block-themed block-transparent mb-0">
<div class="block-header bg-primary-dark">
<h4 class="block-title">Edit Teacher</h4>
</div>
<div class="block-content">
<form autocomplete="off" class="app_frm" action="app/routes/update_teacher" method="POST">
<div id="ajax_response"></div>
<?= $utility->csrf_field('update_teacher.php', 600) ?>
</form>
</div>
</div>
</div>
