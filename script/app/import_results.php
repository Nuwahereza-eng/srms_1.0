...
<title><?php echo $info['name'].' - Import Results'; ?></title>
...
<form autocomplete="off" enctype="multipart/form-data" class="app_frm" action="app/routes/import_results" method="POST">
<div class="row">
<label class="col-sm-12 col-form-label">Class</label>
<div class="col-sm-12">
<select style="width:100%;" class="form-control select_2" name="class" onchange="start_import(this.value);" required>
...
<div class="col-sm-12">
<select style="width:100%;" class="form-control select_2" id="subject_select" name="subjects[]" required multiple="true">
...
<div class="col-sm-12">
<select style="width:100%;" class="form-control select_2" name="term" onchange="get_ca_info(this.value);" required>
<option value="" selected disabled></option>
<?php
...
<div class="row">
<label class="col-sm-12 col-form-label">Continuous Assessment</label>
<div class="col-sm-12">
<select style="width:100%;" class="form-control select_2" name="ca" id="ca_select" required>
</select>
</div>
</div>
<div class="row mb-4">
<label class="col-sm-12 col-form-label">Excel File(s)</label>
<div class="col-sm-12">
<input class="form-control" type="file" name="files[]" multiple="true" required>
</div>
</div>
<?= $utility->csrf_field('import_results.php', 3600) ?>
