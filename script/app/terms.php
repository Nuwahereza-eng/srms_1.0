...
<title><?php echo $info['name'].' - Academic Terms'; ?></title>
...
<h4 class="block-title">Add Academic Terms</h4>
</div>
<div class="block-content">
<form autocomplete="off" class="app_frm" action="app/routes/add_term" method="POST">
<div class="mb-2">
<label class="form-label">Name</label>
<input type="text" required class="form-control" name="name" placeholder="Enter term name">
</div>
<div class="mb-2">
<label class="form-label">Continuous Assessments</label>
<select required class="form-control select_2" name="ca[]" multiple style="width:100%">
<?php
...
<?= $utility->csrf_field('add_term.php', 600) ?>
<div class="mb-4">
...
<div class="block block-rounded block-themed block-transparent mb-0">
<div class="block-header bg-primary-dark">
<h4 class="block-title">Edit Academic Term</h4>
</div>
<div class="block-content">
<form autocomplete="off" class="app_frm" action="app/routes/update_term" method="POST">
<div id="ajax_response"></div>
<?= $utility->csrf_field('update_term.php', 600) ?>
</form>
</div>
</div>
</div>
