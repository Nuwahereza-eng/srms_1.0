...
$document_title = ''.$classes->show($_SESSION['report_data']['class'])['name'].' '.$terms->show($_SESSION['report_data']['term'])['name'].' Examination Report';
...
<b>Term:</b> '.$terms->show($_SESSION['report_data']['term'])['name'].'
</div>
</td>
<td width="25%">
