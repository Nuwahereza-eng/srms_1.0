...
<title><?php echo $info['name'].' - Continuous Assessments'; ?></title>
...
<h4 class="block-title">Add Continuous Assessments</h4>
</div>
<div class="block-content">
<form autocomplete="off" class="app_frm" action="app/routes/add_ca" method="POST">
<div class="mb-2">
<label class="form-label">Name</label>
<input type="text" required class="form-control" name="name" placeholder="Enter continuous asessment name">
</div>
<div class="mb-2">
<label class="form-label">Weight</label>
<input type="text" required class="form-control score-range" name="weight" placeholder="Enter weight">
</div>
<div class="mb-3">
...
<?= $utility->csrf_field('add_ca.php', 600) ?>
<div class="mb-4">
...
<div class="block block-rounded block-themed block-transparent mb-0">
<div class="block-header bg-primary-dark">
<h4 class="block-title">Edit Continuous Assessment</h4>
</div>
<div class="block-content">
<form autocomplete="off" class="app_frm" action="app/routes/update_ca" method="POST">
<div id="ajax_response"></div>
<?= $utility->csrf_field('update_ca.php', 600) ?>
</form>
</div>
</div>
</div>
