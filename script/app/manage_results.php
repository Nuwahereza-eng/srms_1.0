...
<form autocomplete="off" enctype="multipart/form-data" class="app_frm" action="app/routes/manage_results" method="POST">
<div class="row">
<label class="col-sm-12 col-form-label">Class</label>
<div class="col-sm-12">
<select style="width:100%;" class="form-control select_2" name="class" onchange="start_manage(this.value);" required>
...
<div class="row">
<label class="col-sm-12 col-form-label">Students</label>
<div class="col-sm-12">
<select style="width:100%;" class="form-control select_2" id="student_select" name="students[]" required multiple="true">
...
<?= $utility->csrf_field('manage_results.php', 600) ?>
