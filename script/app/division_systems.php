...
<title><?php echo $info['name'].' - Division Systems'; ?></title>
...
<h4 class="block-title">Add Division System</h4>
</div>
<div class="block-content">
<form autocomplete="off" class="app_frm" action="app/routes/add_division_system" method="POST">
<div class="mb-2">
<label class="form-label">Name</label>
<input type="text" required class="form-control" name="name" placeholder="Enter division system name">
</div>
...
<input type="text" name="scale_name[]" class="form-control txt_upper" required>
</div>
<div class="col-xl-2 col-l-2 col-md-6 col-sm-12 mb-2">
<label class="form-label">Minimum Point</label>
<input type="text" name="min_point[]" class="form-control score-range" required>
</div>
<div class="col-xl-2 col-l-2 col-md-6 col-sm-12 mb-2">
<label class="form-label">Maximum Point</label>
<input type="text" name="max_point[]" class="form-control score-range" required>
</div>
...
<?= $utility->csrf_field('add_division_system.php', 600) ?>
<div class="mb-4">
...
<div class="block block-rounded block-themed block-transparent mb-0">
<div class="block-header bg-primary-dark">
<h4 class="block-title">Edit Division System</h4>
</div>
<div class="block-content">
<form autocomplete="off" class="app_frm" action="app/routes/update_division_system" method="POST">
<div id="ajax_response"></div>
<?= $utility->csrf_field('update_division_system.php', 600) ?>
</form>
</div>
</div>
</div>
...
ajax: {
url: 'ajax_tables/division_system_list',
type: "GET"
},
