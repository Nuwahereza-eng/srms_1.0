...
<form autocomplete="off" class="app_frm" enctype="multipart/form-data" action="app/routes/import_students" method="POST">
<div class="row mb-2">
...
<input type="file" accept=".xlsx" name="file" accept="application/msexcel" required class="form-control">
</div>
<div class="mb-3">
<div class="alert alert-info" role="alert">
Download excel template from <a download href="storage/templates/import_students.xlsx" class="alert-link">here</a>.
</div>
</div>
<?= $utility->csrf_field('import_students.php', 600) ?>
