!function() {
    var e = {
        ...
        221: function(e, t, i) {
            ...
            e.exports = function(e, t, i) {
                var l, c, d, h, u, p, f = 0, m = !1, g = !1, _ = !0;
                ...
                function x() {
                    ...
                    return void 0 === u && (u = setTimeout(y, t)),
                    h
                }
                return t = o(t) || 0,
                s(i) && (m = !!i.leading,
                d = (g = "maxWait"in i) ? r(o(i.maxWait) || 0, t) : d,
        ...
        374: function(e, t, i) {
            ...
            e.exports = function(e) {
                ...
                e = s(e);
                var i = a.test(e);
                return i || l.test(e) ? c(e.slice(2), i ? 2 : 8) : r.test(e) ? NaN : +e
            }
        },
        394: function(e, t, i) {
            var s = i(552)
        ...
        552: function(e, t, i) {
            ...
            e.exports = function(e) {
                return null == e ? void 0 === e ? "[object Undefined]" : "[object Null]" : r && r in Object(e) ? n(e) : o(e)
            }
        },
        659: function(e, t, i) {
            var s = i(873)
        ...
        969: function(e, t, i) {
            ...
            e.exports = function(e, t, i) {
                ...
                if ("function" != typeof e)
                    throw new TypeError("Expected a function");
                return n(i) && (o = "leading"in i ? !!i.leading : o,
    ...
    function() {
        ...
        var Z = {
            ...
            phase: "main",
            fn: function(e) {
                var t, i = e.state, a = e.name, c = e.options, d = i.elements.arrow, h = i.modifiersData.popperOffsets, u = M(i.placement), p = X(u), f = [r, o].indexOf(u) >= 0 ? "height" : "width";
                if (d && h) {
                    var m = function(e, t) {
        ...
        function ge(e) {
            var t, i = e.reference, a = e.element, l = e.placement, h = l ? M(l) : null, u = l ? J(l) : null, p = i.x + i.width / 2 - a.width / 2, f = i.y + i.height / 2 - a.height / 2;
            switch (h) {
            case s:
                t = {
                    x: p,
        ...
        var be = {
            ...
            fn: function(e) {
                ...
                if (!t.modifiersData[d]._skip) {
                    for (var h = i.mainAxis, u = void 0 === h || h, p = i.altAxis, f = void 0 === p || p, _ = i.fallbackPlacements, b = i.padding, v = i.boundary, y = i.rootBoundary, w = i.altBoundary, x = i.flipVariations, E = void 0 === x || x, k = i.allowedAutoPlacements, A = t.options.placement, L = M(A), S = _ || (L !== A && E ? function(e) {
                        if (M(e) === a)
                            return [];
                        var t = re(e);
                        return [le(e), t, le(t)]
        ...
        var we = {
          ...
          , ke = {
            ...
            fn: function(e) {
                ...
                if (S) {
                    if (d) {
                        var I, q = "y" === A ? s : r, W = "y" === A ? n : o, H = "y" === A ? "height" : "width", z = S[A], B = z + w[q], R = z - w[W], Q = b ? -O[H] / 2 : 0, V = E === c ? C[H] : O[H], K = E === c ? -O[H] : -C[H], G = t.elements.arrow, Z = b && G ? $(G) : {
                            width: 0,
                            height: 0
                            ...
                            bottom: 0,
                            left: 0
                        }, te = ee[q], ie = ee[W], se = U(0, C[H], Z[H]), ne = k ? C[H] / 2 - Q - se - te - T.mainAxis : V - se - te - T.mainAxis, oe = k ? -C[H] / 2 + Q + se + ie + T.mainAxis : K + se + ie + T.mainAxis, re = t.elements.arrow && Y(t.elements.arrow), ae = re ? "y" === A ? re.clientTop || 0 : re.clientLeft || 0 : 0, le = null != (I = null == D ? void 0 : D[A]) ? I : 0, ce = z + oe - le, de = U(b ? P(B, z + ne - le - ae) : B, z, b ? N(R, ce) : R);
                        S[A] = de,
                        F[A] = de - z
                    }
                    if (u) {
                        var he, ue = "x" === A ? s : r, pe = "x" === A ? n : o, fe = S[L], me = "y" === L ? "height" : "width", ge = fe + w[ue], be = fe - w[pe], ve = -1 !== [s, r].indexOf(x), ye = null != (he = null == D ? void 0 : D[L]) ? he : 0, we = ve ? ge : fe - C[me] - O[me] - ye + T.altAxis, xe = ve ? fe + C[me] + O[me] - ye - T.altAxis : be, Ee = b && ve ? function(e, t, i) {
                            var s = U(e, t, i);
                            return s > i ? i : s
                        }(we, fe, xe) : U(b ? we : ge, fe, b ? xe : be);
                        S[L] = Ee,
                        F[L] = Ee - fe
                    }
                    t.modifiersData[a] = F
        ...
        var je = Oe()
          , Te = Oe({
            defaultModifiers: [ne, Ee, ie, D, xe, be, ke, Z, we]
        })
          , De = Oe({
        ...
        class It extends bt {
            ...
            _initEvents() {
                this._supportPointerEvents ? (pt.on(this._element, Mt, (e => this._start(e))),
        ...
        class li extends vt {
            ...
            _addEventListeners() {
                this._config.keyboard && pt.on(this._element, Xt, (e => this._keydown(e))),
                "hover" === this._config.pause && (pt.on(this._element, Ut, ( () => this.pause())),
            ...
            _slide(e, t=null) {
                ...
                const i = this._getActive()
                  , s = e === zt
                  , n = t || Ge(this._getItems(), i, s, this._config.wrap);
                if (n === i)
                    return;
        ...
        class xi extends vt {
            ...
            hide() {
                if (this._isTransitioning || !this._isShown())
                    return;
                if (pt.trigger(this._element, ui).defaultPrevented)
                    return;
        ...
        class Yi extends vt {
            constructor(e, t) {
                ...
                this._menu = wt.next(this._element, qi)[0] || wt.prev(this._element, qi)[0] || wt.findOne(qi, this._parent),
            ...
            _selectMenuItem({key: e, target: t}) {
                ...
                i.length && Ge(i, t, e === Si, !i.includes(t)).focus()
            }
            static jQueryInterface(e) {
                return this.each((function() {
        ...
        class Ji extends bt {
            ...
            dispose() {
                this._isAppended && (pt.off(this._element, Ki),
                this._element.remove(),
                this._isAppended = !1)
            }
            _getElement() {
        ...
        class Cs extends vt {
            ...
            show(e) {
                this._isShown || this._isTransitioning || pt.trigger(this._element, gs, {
                    relatedTarget: e
            ...
            hide() {
                this._isShown && !this._isTransitioning && (pt.trigger(this._element, ps).defaultPrevented || (this._isShown = !1,
                this._isTransitioning = !0,
            ...
            _triggerBackdropTransition() {
                if (pt.trigger(this._element, fs).defaultPrevented)
                    return;
                const e = this._element.scrollHeight > document.documentElement.clientHeight
                  , t = this._element.style.overflowY;
                "hidden" === t || this._element.classList.contains(As) || (e || (this._element.style.overflowY = "hidden"),
        ...
        pt.on(document, xs, '[data-bs-toggle="modal"]', (function(e) {
            const t = wt.getElementFromSelector(this);
            ...
            i && Cs.getInstance(i).hide(),
            Cs.getOrCreateInstance(t).toggle(this)
        }
        )),
        xt(Cs),
        Xe(Cs);
        ...
        class Vs extends vt {
            ...
            show(e) {
                this._isShown || pt.trigger(this._element, Fs, {
                    relatedTarget: e
                }).defaultPrevented || (this._isShown = !0,
                this._backdrop.show(),
            ...
            hide() {
                this._isShown && (pt.trigger(this._element, qs).defaultPrevented || (this._focustrap.deactivate(),
                this._element.blur(),
                this._isShown = !1,
        ...
        pt.on(window, Hs, ( () => {
            for (const e of wt.find("[aria-modal][class*=show][class*=offcanvas-]"))
                "fixed" !== getComputedStyle(e).position && Vs.getOrCreateInstance(e).hide()
        }
        )),
        xt(Vs),
        Xe(Vs);
        ...
        class pn extends vt {
            ...
            hide() {
                if (this._isShown() && !pt.trigger(this._element, this.constructor.eventName("hide")).defaultPrevented) {
                    if (this._getTipElement().classList.remove(nn),
                    "ontouchstart"in document.documentElement)
                        for (const e of [].concat(...document.body.children))
                            pt.off(e, "mouseover", Be);
                ...
                for (const t of e)
                    if ("click" === t)
                        ...
                        pt.on(this._element, i, this._config.selector, (e => {
                            const t = this._initializeOnDelegatedTarget(e);
                            t._activeTrigger["focusout" === e.type ? cn : ln] = t._element.contains(e.relatedTarget),
                            t._leave()
                        }
                        ))
                    }
        ...
        class On extends vt {
            ...
            _maybeEnableSmoothScroll() {
                this._config.smoothScroll && (pt.off(this._config.target, wn),
            ...
            _process(e) {
                ...
                pt.trigger(this._element, yn, {
                    relatedTarget: e
                }))
            }
            _activateParents(e) {
                if (e.classList.contains("dropdown-item"))
                    wt.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(En);
                else
                    for (const t of wt.parents(e, ".nav, .list-group"))
                        for (const e of wt.prev(t, Ln))
                            e.classList.add(En)
            }
            _clearActiveClass(e) {
                e.classList.remove(En);
                const t = wt.find(`${kn}.${En}`, e);
                for (const e of t)
                    e.classList.remove(En)
            }
            static jQueryInterface(e) {
        ...
        const jn = ".bs.tab"
          ...
          , Gn = `.${Rn}[data-bs-toggle="tab"], .${Rn}[data-bs-toggle="pill"], .${Rn}[data-bs-toggle="list"]`;
        class Zn extends vt {
            constructor(e) {
                super(e),
            ...
            _keydown(e) {
                if (![qn, Wn, $n, Hn, zn, Bn].includes(e.key))
                    return;
                e.stopPropagation(),
                e.preventDefault();
        ...
        pt.on(document, Pn, Un, (function(e) {
            ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
            He(this) || Zn.getOrCreateInstance(this).show()
        }
        )),
        pt.on(window, In, ( () => {
            for (const e of wt.find(Gn))
        ...
        class fo extends vt {
            ...
            show() {
                pt.trigger(this._element, ro).defaultPrevented || (this._clearTimeout(),
            ...
            hide() {
                this.isShown() && (pt.trigger(this._element, no).defaultPrevented || (this._element.classList.add(ho),
                this._queueCallback(( () => {
        ...
        var ko = !("undefined" == typeof window || !window.document || !window.document.createElement)
          , Ao = Object.freeze({
            __proto__: null,
            addClasses: wo,
            canUseDOM: ko,
            classNamesToQuery: Eo,
            getElementDocument: vo,
            getElementWindow: bo,
            getOptions: yo,
            removeClasses: xo
        })
        ...
        ko && window.addEventListener("resize", (function() {
            So !== window.devicePixelRatio && (So = window.devicePixelRatio,
            Lo = null)
        }
        ));
        var Oo = bo
          ...
          , Po = function() {
            function e(t, i) {
                ...
                this.onScroll = function() {
                    ...
                    Do(s.el, s.classNames.scrolling)),
                    s.showScrollbar("x"),
                    s.showScrollbar("y"),
                    s.onStopScrolling()
                }
                ...
                this._onStopScrolling = function() {
                    Mo(s.el, s.classNames.scrolling),
                ...
                this.onMouseEnter = function() {
                    s.isMouseEntering || (Do(s.el, s.classNames.mouseEntered),
                    s.showScrollbar("x"),
                    s.showScrollbar("y"),
                    s.isMouseEntering = !0),
                    s.onMouseEntered()
                ...
                this._onMouseEntered = function() {
                    Mo(s.el, s.classNames.mouseEntered),
                    s.options.autoHide && (s.hideScrollbar("x"),
                    s.hideScrollbar("y")),
                    s.isMouseEntering = !1
                }
                ...
                ,
                this.el = t,
                this.options = _o(_o({}, e.defaultOptions), i),
                this.classNames = _o(_o({}, e.defaultOptions.classNames), i.classNames),
                this.axis = {
                    x: {
                ...
                this.onMouseMove = go(this._onMouseMove, 64),
                this.onWindowResize = mo(this._onWindowResize, 64, {
                    leading: !0
                }),
                this.onStopScrolling = mo(this._onStopScrolling, this.stopScrollDelay),
            ...
            e.prototype.getScrollbarWidth = function() {
                try {
                    return this.contentWrapperEl && "none" === getComputedStyle(this.contentWrapperEl, "::-webkit-scrollbar").display || "scrollbarWidth"in document.documentElement.style || "-ms-overflow-style"in document.documentElement.style ? 0 : Co()
                } catch (e) {
                    return Co()
                }
            }
            ...
            e.prototype.initDOM = function() {
                var e, t;
                this.wrapperEl = this.el.querySelector(No(this.classNames.wrapper)),
                this.contentWrapperEl = this.options.scrollableNode || this.el.querySelector(No(this.classNames.contentWrapper)),
                this.contentEl = this.options.contentNode || this.el.querySelector(No(this.classNames.contentEl)),
                this.offsetEl = this.el.querySelector(No(this.classNames.offset)),
                this.maskEl = this.el.querySelector(No(this.classNames.mask)),
                this.placeholderEl = this.findChild(this.wrapperEl, No(this.classNames.placeholder)),
                this.heightAutoObserverWrapperEl = this.el.querySelector(No(this.classNames.heightAutoObserverWrapperEl)),
                this.heightAutoObserverEl = this.el.querySelector(No(this.classNames.heightAutoObserverEl)),
                this.axis.x.track.el = this.findChild(this.el, "".concat(No(this.classNames.track)).concat(No(this.classNames.horizontal))),
                this.axis.y.track.el = this.findChild(this.el, "".concat(No(this.classNames.track)).concat(No(this.classNames.vertical))),
                this.axis.x.scrollbar.el = (null === (e = this.axis.x.track.el) || void 0 === e ? void 0 : e.querySelector(No(this.classNames.scrollbar))) || null,
                this.axis.y.scrollbar.el = (null === (t = this.axis.y.track.el) || void 0 === t ? void 0 : t.querySelector(No(this.classNames.scrollbar))) || null,
                this.options.autoHide || (Do(this.axis.x.scrollbar.el, this.classNames.visible),
                Do(this.axis.y.scrollbar.el, this.classNames.visible))
            }
            ,
            e.prototype.initListeners = function() {
                var e, t = this, i = Oo(this.el);
            ...
            e.prototype.showScrollbar = function(e) {
                void 0 === e && (e = "y"),
                this.axis[e].isOverflowing && !this.axis[e].scrollbar.isVisible && (Do(this.axis[e].scrollbar.el, this.classNames.visible),
                this.axis[e].scrollbar.isVisible = !0)
            }
            ,
            e.prototype.hideScrollbar = function(e) {
                void 0 === e && (e = "y"),
                this.isDragging || this.axis[e].isOverflowing && this.axis[e].scrollbar.isVisible && (Mo(this.axis[e].scrollbar.el, this.classNames.visible),
            ...
            e.prototype.onMouseMoveForAxis = function(e) {
                ...
                Do(t.track.el, this.classNames.hover),
                this.isWithinBounds(t.scrollbar.rect) ? Do(t.scrollbar.el, this.classNames.hover) : Mo(t.scrollbar.el, this.classNames.hover)) : (Mo(t.track.el, this.classNames.hover),
                this.options.autoHide && this.hideScrollbar(e)))
            }
            ,
            e.prototype.onMouseLeaveForAxis = function(e) {
                void 0 === e && (e = "y"),
                Mo(this.axis[e].track.el, this.classNames.hover),
                Mo(this.axis[e].scrollbar.el, this.classNames.hover),
                this.options.autoHide && this.hideScrollbar(e)
            }
            ,
            e.prototype.onDragStart = function(e, t) {
                ...
                this.draggedAxis = t,
                Do(this.el, this.classNames.dragging),
          ...
          , Ho = function(e) {
            ...
            t.initDOMLoadedElements = function() {
                ...
                Array.prototype.forEach.call(document.querySelectorAll("[data-simplebar]"), (function(e) {
                    "init" === e.getAttribute("data-simplebar") || t.instances.has(e) || new t(e,qo(e.attributes))
                }
                ))
            }
            ,
            ...
            t.prototype.initDOM = function() {
                ...
                if (!Array.prototype.filter.call(this.el.children, (function(e) {
                    ...
                    Wo(this.wrapperEl, this.classNames.wrapper),
                    Wo(this.contentWrapperEl, this.classNames.contentWrapper),
                    Wo(this.offsetEl, this.classNames.offset),
                    Wo(this.maskEl, this.classNames.mask),
                    Wo(this.contentEl, this.classNames.contentEl),
                    Wo(this.placeholderEl, this.classNames.placeholder),
                    Wo(this.heightAutoObserverWrapperEl, this.classNames.heightAutoObserverWrapperEl),
                    Wo(this.heightAutoObserverEl, this.classNames.heightAutoObserverEl); this.el.firstChild; )
                ...
                if (!this.axis.x.track.el || !this.axis.y.track.el) {
                    ...
                    Wo(n, this.classNames.track),
                    Wo(o, this.classNames.scrollbar),
                    n.appendChild(o),
                    this.axis.x.track.el = n.cloneNode(!0),
                    Wo(this.axis.x.track.el, this.classNames.horizontal),
                    this.axis.y.track.el = n.cloneNode(!0),
                    Wo(this.axis.y.track.el, this.classNames.vertical),
                    this.el.appendChild(this.axis.x.track.el),
                    this.el.appendChild(this.axis.y.track.el)
                }
                Po.prototype.initDOM.call(this),
                this.el.setAttribute("data-simplebar", "init")
            }
            ,
            t.prototype.unMount = function() {
                Po.prototype.unMount.call(this),
            ...
            t.handleMutations = function(e) {
                e.forEach((function(e) {
                    e.addedNodes.forEach((function(e) {
                        1 === e.nodeType && (e.hasAttribute("data-simplebar") ? !t.instances.has(e) && document.documentElement.contains(e) && new t(e,qo(e.attributes)) : e.querySelectorAll("[data-simplebar]").forEach((function(e) {
                            "init" !== e.getAttribute("data-simplebar") && !t.instances.has(e) && document.documentElement.contains(e) && new t(e,qo(e.attributes))
                        }
                        )))
                    }
                    )),
        ...
        class Qo {
            ...
            _uiHandleSidebars() {
                ...
                this._uiHandleSidebars("custom-scroll")) : (e = "custom-scroll") && t._lPage.classList.contains("side-scroll") && (t._lSidebar && !t._lSidebarScroll && (t._lSidebarScroll = new Ho(t._lSidebarScrollCon)),
                t._lSideOverlay && !t._lSideOverlayScroll && (t._lSideOverlayScroll = new Ho(t._lSideOverlay))))
            }
            _uiHandleHeader() {
                let e = this;
            ...
            _uiHandleDarkMode(e) {
                ...
                if (["on", "off", "system"].includes(e))
                    "on" === e ? (t._lHtml.classList.add("dark"),
                    t._darkMode = "on",
                    i && localStorage.setItem("lmsDarkMode", "on"),
                    null == s || s.classList.remove("active"),
                    null == n || n.classList.add("active"),
                    null == o || o.classList.remove("active"),
                    r && (r.className = "fa fa-fw fa-moon")) : "off" === e ? (t._lHtml.classList.remove("dark"),
                    t._darkMode = "off",
                    i && localStorage.setItem("lmsDarkMode", "off"),
                    null == s || s.classList.add("active"),
                    null == n || n.classList.remove("active"),
                    null == o || o.classList.remove("active"),
                    r && (r.className = "far fa-fw fa-moon")) : "system" === e && (window.matchMedia("(prefers-color-scheme: dark)").matches ? (t._lHtml.classList.add("dark"),
                    r && (r.className = "fa fa-fw fa-moon")) : (t._lHtml.classList.remove("dark"),
                    r && (r.className = "far fa-fw fa-moon")),
                    t._darkMode = "system",
                    i && localStorage.setItem("lmsDarkMode", "system"),
                    null == s || s.classList.remove("active"),
                    null == n || n.classList.remove("active"),
                    null == o || o.classList.add("active"));
                else {
                    let e = "";
                    i ? e = localStorage.getItem("lmsDarkMode") || t._darkMode : (localStorage.removeItem("lmsDarkMode"),
                    e = t._darkMode),
                    "on" === e ? t._uiHandleDarkMode("on") : "off" === e ? t._uiHandleDarkMode("off") : "system" === e && t._uiHandleDarkMode("system"),
            ...
            _uiHandleTheme() {
                ...
                if (i) {
                    let i = localStorage.getItem("lmsColorTheme") || !1;
                    i && e._uiUpdateTheme(t, i),
                    t = document.getElementById("css-theme")
                } else
                    localStorage.removeItem("lmsColorTheme");
                ...
                document.querySelectorAll('[data-toggle="theme"]').forEach((s => {
                    s.addEventListener("click", (n => {
                        ...
                        t = document.getElementById("css-theme"),
                        i && localStorage.setItem("lmsColorTheme", o)
                    }
                    ))
                }
                ))
            ...
            helpersOnLoad(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                this.onLoad(( () => Ro.run(e, t)))
            }
        }
        window.lms = new class extends Qo {
            constructor(e) {
                super(e)
            }
        }
...
$(document).on('input', '.score-range', function() {
    let val = $(this).val();
...
$(document).on('blur', '.score-range', function() {
    let val = $(this).val();
    if (val !== '') {
        let num = parseFloat(val);
        if (!isNaN(num)) {
            if (num === 100) {
                $(this).val('100'); // no decimal for 100
            } else if (num < 1 && val.startsWith('.')) {
                $(this).val('0.' + num.toString().split('.')[1]);
            } else {
                $(this).val(num.toFixed(1)); // one decimal for other numbers
            }
        } else {
            $(this).val('');
        }
