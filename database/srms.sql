...
(1, 'Mwangavu Secondary School', '+256 414 200 100', '+256 772 500 200', 'info@mwangavusec.ac.ug', 'admissions@mwangavusec.ac.ug', 'P.O. Box 2845, Kibuli Hill, Kampala, Uganda', 'logo_1762686117.png', 'icon_1762686212.png', 'stamp_1762687221.png', 'YES', 'Africa/Kampala', 'Lighting the Path to Knowledge and Excellence.', 'MSS', '0', 'sidebar-dark');
...
(1, 'Abdul', 'Sserwanga', 'Male', 'abdul.sserwanga@srms.test', '$2y$10$f54QD6/8vwleOyPSpQLTuurOfoOiZoxzlxmQRpLIqkwrlHqpMeA1C', 'ADMIN', 'ENABLED');
